...
Corrections v1.10.2 (depuis v1.9.2) :
...
class ScripturaApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Scriptura v1.10.2"); self.setGeometry(50,50,1400,900)
    ...
    def new_project(self):
        ...
        self.setWindowTitle(f"Scriptura v1.10.2 — {title}")
        self.current_item = None
        self._exit_composite_mode()
    ...
    def open_project(self, path=None):
        ...
        self.setWindowTitle(f"Scriptura v1.10.2 — {self.pm.project_data.title}")
        self.current_item = None
        self.editor.blockSignals(True); self.editor.clear(); self.editor.blockSignals(False)
        self.goal_btn.setVisible(False); self.goal_progress.setVisible(False)
